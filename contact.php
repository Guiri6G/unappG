						...
						<div class="row">
							<div class="col-md-12">
								<div class="contact-info-wrap-flex">
									<div class="con-info">
										<p><span><i class="icon-location-2"></i></span> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer aliquam ex et lectus gravida, vitae eleifend nisl eleifend. In at libero felis. Vivamus pretium finibus justo sed fermentum. Ut fringilla et massa id hendrerit. Vivamus congue dolor nec dolor cursus </p>
									</div>
						...
						<form action="#">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" id="subject" class="form-control" placeholder="Votre problème">
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Vote message"></textarea>
								</div>
							</div>
