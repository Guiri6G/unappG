<footer id="colorlib-footer">
			<div class="container">
				<div class="row row-pb-md">
					...
					<div class="col-md-3 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								...
								<li><a href="#"><i class="icon-check"></i> Activité du club</a></li>
					...
					<div class="col-md-3 colorlib-widget right ">
						<h4>Contactez-nous</h4>
						<ul class="colorlib-footer-links">
							<li><i class="icon-location4"></i> 6 rue Yvonne de Gaulle, <br> Asnières sur Marne 92600</li>
							<li><a href="mailto:nolimitcenter@gmail.com"><i class="icon-envelope"></i> nolimitcenter@gmail.com</a></li>
						</ul>
					</div>
				</div>
			</div>
